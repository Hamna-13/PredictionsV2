...
if (!empty($group_id)) {
    ...
    $groupQuery = "SELECT groups.groupName, tournaments.tournamentName
                   FROM groups
    ...
    if ($groupResult && mysqli_num_rows($groupResult) > 0) {
        ...
        $participantsQuery = "SELECT dense_rank() over (order by user_group.points desc) as rank, 
            user.username, user_group.points
            FROM user 
    ...
    <body style="font-family: 'Poppins', sans-serif;font-weight:600 ;color:#1f1d47">
        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <!-- partial -->
                <div class="main-panel" style="font-family:  'Poppins', sans-serif !important; color :#1f1d47 !important">
                    <div class="content-wrapper" style="background-color:#dfebf7">
                        <div class="d-flex justify-content-between">
                            <div>

                                <h3 class="card-title mb-1" style="font-family:  'Poppins', sans-serif; color :#1f1d47;font-weight:1000"><?php echo $groupName; ?></h4>
                        ...
                        <div class="row">
                            <div class="col-md-8 grid-margin">
                                <div class="card shadow">
                                    <div class="card-body" style="background-color:white; ">
                                        <div class="card-header bg-purple rounded-lg">
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span class="pl-2"><?php echo $participant['rank'] ?></span>
                                                                </td>

                                                                <td> <?php echo ($participant['username']) ?> </td>
                                                                <td> <?php echo ($participant['points']) ?> </td>
                            ...
                            <div class="col-md-4 grid-margin" style="font-family: 'Poppins', sans-serif !important;">
